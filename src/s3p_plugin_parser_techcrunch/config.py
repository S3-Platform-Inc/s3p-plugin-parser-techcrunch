...
config = PluginConfig(
    ...
    payload=payload.PayloadConfig(
        file='techcrunch.py',                 # python файл плагина (точка входа). Этот файл должен быть указан в `plugin.files[*]`
        classname='Techcrunch',               # имя python класса в указанном файле
